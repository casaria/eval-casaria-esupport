                    ...
                    <TR> 
                      <TD> 
                        <TABLE cellSpacing=1 cellPadding=5 width="100%" border=0>
                          ...
                          <TR> 
                            <TD class=subcat> 
                              <form name=timelink method="post" action="http://www.casaria.net/time/login.php">';
                                 echo "<input type=hidden name=login value=$user_info[email]>
                                 <input type=hidden name=md5 value=$user_info[password]>";
                                 echo '<LI><a href="#" onclick="javascript:document.timelink.submit();">My Time Tracker</a></LI>
                              </form>		
                              <form name=emaillink method="post" action="http://www.casaria.net:2095/horde/index.php">';
                                 echo "<input type=hidden name=login value=$user_info[email]>
                                 <input type=hidden name=md5 value=$user_info[password]>";
                              		
                                 echo '<LI><a href="#" onclick="javascript:document.emaillink.submit();">'; echo $lang_lnk_email;
                                 echo '</a></LI>';
                              echo '</form>           
                              <form name=quickbooks method="post" action="https://login.quickbooks.com/j/qbn/auth/employee?service_flags=0&url=https%3A%2F%2Faccounting.quickbooks.com%2Fqbo%23%23c2004c%23%23%2Flogin%2Frecordnew&serviceid=2004">';
                                 echo '<input type=hidden name=login value=$user_info[email]>';
                                 echo '<input type=hidden name=md5 value=$user_info[password]>';
                              	
                                echo '<LI><a href="#" onclick="javascript:document.quickbooks.submit();">';
                                echo $lang_lnk_quickbooks; 
                                echo '</a></LI>
                              </form>           
