...
**	file:	alist.php
**
**	This file lists the admins from the database and provides the links
	...
	echo '
		<TABLE class=border cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
			...
			<TABLE cellSpacing=1 cellPadding=5 width="100%" border=0>
				...
				<option value="index.php?t=alist&o=id"'; if($o=='id') echo ' selected'; echo '>'.$lang_id.'</option>
				<option value="index.php?t=alist&o=user_name"'; if($o=='user_name') echo ' selected'; echo '>'.$lang_username.'</option>
				<option value="index.php?t=alist&o=office"'; if($o=='office') echo ' selected'; echo '>'.$lang_office.'</option>
				</select></b></td></form>
				</TR>		
			</td></tr>
			</td></tr>
		...
		if($offset < 0){
			...
			echo "&nbsp;<a href=index.php?t=alist&o=$o&offset=$offset>$lang_previous</a>";
		}
		...
		if($offset < getTotalAdmins()){
			echo "&nbsp;<a href=index.php?t=alist&o=$o&offset=$offset>$lang_next</a>";
		}
		else{
			echo "&nbsp;$lang_next";
		}
