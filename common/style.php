...
<HEAD>
	...
	<STYLE type="text/css">
		...
		td.subcat {background: <?php echo $theme['subcategory']; ?>; color: <?php echo $theme['text']; ?>; font-family: "<?php echo $theme['font']; ?>"; font-size: <?php echo $theme['font_size'].'px;'; ?> font-weight:700}
