...
<script type="text/javascript">
    WebFontConfig = {
        google: { families: [ 'Roboto::latin', 'Lato::latin', 'Roboto+Condensed::latin', 'Ropa+Sans:latin', 'Titillium+Web:500,600,700:latin'] }
    };
...
<HEAD>
    ...
    <STYLE type="text/css">
        ...
        .alternate tr:nth-child(2n):hover, .alternate tr:hover {background-color: #E7FF00; }
        ...
        */
        ...
        a.hf:link {line-height: <?php echo $lineHeight; ?>; background-color: #3e3e3e;  btext-decoration: none; font-weight: normal;  font-family: "<?php echo $theme['font']; ?>"; font-size: <?php echo $theme['font_size']; ?>px; color: #f4a62b;}
