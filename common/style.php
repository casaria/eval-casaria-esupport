...
<HEAD>
    ...
    <STYLE type="text/css">
        ...
        .alternate tr:nth-child(3n) {background-color: <?php echo $theme['bg1']; ?>;}
        .alternate tr:nth-child(3n):hover, .alternate tr:hover {background-color: #E7FF00; }
        .alternate tr:nth-child(3n+1) {background-color: <?php echo $theme['bg2']; ?>;}
