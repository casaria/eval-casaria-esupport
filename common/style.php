...
<script type="text/javascript">
    WebFontConfig = {
        google: { families: [ 'Roboto::latin', 'Lato::latin', 'Roboto+Condensed::latin', 'Ropa+Sans:latin', 'Titillium+Web:400,500,800:latin'] }
    };
...
<HEAD>
    ...
    <STYLE type="text/css">
        ...
        td.back {padding: /*?php echo $tablePadding; ?>*/ 2px; line-height: <?php echo $lineHeight; ?>; background: <?php echo $theme['bg1']; ?>;}
